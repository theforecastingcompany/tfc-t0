...
5.23–6.86x faster than PyTorch CPU across three representative workloads. MLX
eager was 2.61–2.67x faster than PyTorch MPS. These measurements exclude model
